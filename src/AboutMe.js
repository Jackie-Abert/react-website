      ...
      <fieldset>
        <div className="aboutme_content_container">
          ...
          <article className="aboutme_text">
            ...
            <p>
              I love the entire creative process, from concept to creation, and I
              especially enjoy working with people who share the same passions for
              code and design as I do. I look forward to joining a team of like
              minded, fun loving geeks like me.{" "}
            </p>
            <p>
              When I'm not coding or designing, I like spending time outside with
              my kids and gaming with my hubby. My family is my life, and
